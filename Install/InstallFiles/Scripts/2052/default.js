...
function OnFinish(selProj, selObj)
{
	try
	{
		...
		PchSettings(selProj);
		ChangeStdAfxCppSetting(selProj);
		InfFile.Delete();
...
// 		group.Filter = strSrcFilter;
	    ...
	    proj.Object.AddFilter('源文件').Filter = 'cpp;c;cc;cxx;def;odl;idl;hpj;bat;asm;asmx';
	    proj.Object.AddFilter('头文件').Filter = 'h;hpp;hxx;hm;inl;inc;xsd';
	    proj.Object.AddFilter('资源文件').Filter = 'rc;ico;cur;bmp;dlg;rc2;rct;bin;rgs;gif;jpg;jpeg;jpe;resx;tiff;tif;png;wav;mfcribbon-ms';
...
function AddConfig(proj, strProjectName)
{
	try
	{
        ...
        config.UseOfMFC = '2';       //MFC DLL
        config.CharacterSet = '1';   //UNICODE
        //调试路径
        config.DebugSettings.command = '..\\..\\..\\Execute\\$(Configuration)\\OFccmTest.exe'

		var CLTool = config.Tools('VCCLCompilerTool');
		// TODO: 添加编译器设置
        CLTool.AdditionalIncludeDirectories = '..\\..\\..\\Include';
        //常规优化 - 警告等级
        ...
        //附件库目录
        LinkTool.AdditionalDependencies = 'TestItemInterface_d.lib ImageProc_d.lib';
        LinkTool.AdditionalLibraryDirectories = '..\\..\\..\\Lib\\$(Configuration)';

        //生成日志
        var BuildEventTool = config.Tools('VCPostBuildEventTool');
        BuildEventTool.CommandLine = 'copy "$(TargetPath)" ..\\..\\..\\Execute\\$(Configuration)\\TestItem';

        var ResourceTool = config.Tools('VCResourceCompilerTool');
        ResourceTool.Culture = '2052';
        ...
        CLTool.UsePrecompiledHeader = '2';
        //启用函数级链接
        CLTool.EnableFunctionLevelLinking = '2';
        //启用内部函数
        CLTool.EnableIntrinsicFunctions = '2';
         //调试信息格式
        ...
        LinkTool.SubSystem = '2';
        //附件库目录
        LinkTool.AdditionalDependencies = 'TestItemInterface.lib ImageProc.lib';
        LinkTool.AdditionalLibraryDirectories = '..\\..\\..\\Lib\\$(Configuration)';
        //启用COMDA折叠
...
function GetTargetName(strName, strProjectName)
{
	try
	{
        ...
        strTarget = strName.replace("Tccm", strProjectName);
