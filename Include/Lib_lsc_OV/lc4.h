...
*/
LC4_API bool LenC_Cal_5650_V4( unsigned char *BmpBuffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
LC4_API bool LenC_Cal_5690_V4( unsigned char *BmpBuffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
LC4_API bool LenC_Cal_8820_V4( unsigned char *BmpBuffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
/* OV8865, OV13850 also call this function LenC_Cal_8830() */
LC4_API bool LenC_Cal_8830_V4( unsigned char *BmpBuffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
LC4_API bool LenC_Cal_8850_V4( unsigned char *BmpBuffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
LC4_API bool LenC_Cal_8858_V4( unsigned char *BmpBuffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
LC4_API bool LenC_Cal_14810_V4( unsigned char *BmpBuffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
LC4_API bool LenC_Cal_12830_V4( unsigned char *BmpBuffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
/*
argument definition:
...
__out int *pLen: output actual register count;
*/
LC4_API bool LenC_Cal_5650_Raw8_V4( unsigned char *Raw8Buffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
LC4_API bool LenC_Cal_5690_Raw8_V4( unsigned char *Raw8Buffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
LC4_API bool LenC_Cal_8820_Raw8_V4( unsigned char *Raw8Buffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
/* OV8865, OV13850 also call this function LenC_Cal_8830_Raw8() */
LC4_API bool LenC_Cal_8830_Raw8_V4( unsigned char *Raw8Buffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
LC4_API bool LenC_Cal_8850_Raw8_V4( unsigned char *Raw8Buffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
LC4_API bool LenC_Cal_8858_Raw8_V4( unsigned char *Raw8Buffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
LC4_API bool LenC_Cal_14810_Raw8_V4( unsigned char *Raw8Buffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
LC4_API bool LenC_Cal_12830_Raw8_V4( unsigned char *Raw8Buffer,  int ImageWidth,  int ImageHeight,  int percent,  unsigned char offset,  unsigned char *pLenCReg,  int *pLen);
