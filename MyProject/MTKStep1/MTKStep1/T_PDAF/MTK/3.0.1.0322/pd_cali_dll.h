...
PD_CALI_DLL_API PD_ERR_CODE pd_cali_proc2(char **raw_seq, int *lens_pos, int num, char* proc1_data, char* output, int max_output_size, int& output_size);
...
PD_CALI_DLL_API PD_ERR_CODE pd_cali_get_target_DAC(unsigned short*raw, unsigned char *eeprom_buf_proc1, unsigned char *eeprom_buf_proc2, int currentDAC, int& targetDAC);
