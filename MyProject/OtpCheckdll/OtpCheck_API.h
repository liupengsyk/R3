...
typedef struct _GetTestSpec
{
	...
	int		m_VCMID;						// Fixed Value,refer to OTP Guide
	...
	int		m_SupplierCode;					// Fixed Value,refer to OTP Guide
	...
	//新增20170607
	int		m_EEPROMID;						// Fixed Value,refer to OTP Guide
	//新增20170704
...
private:
	...
	BOOL LensVerificationLib(CString str,USHORT *Data,wchar_t *sErrorMsg,BOOL isWide = TRUE);
