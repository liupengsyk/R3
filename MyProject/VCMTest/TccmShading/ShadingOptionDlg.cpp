...
void ShadingOptionDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_Y1diffmax,Y1diffmax);
	DDX_Text(pDX, IDC_Y1diffmin,Y1diffmin);

	DDX_Text(pDX, IDC_Y2diffmax,Y2diffmax);
	DDX_Text(pDX, IDC_Y2diffmin,Y2diffmin);

	DDX_Text(pDX, IDC_Y3diffmax,Y3diffmax);
	DDX_Text(pDX, IDC_Y3diffmin,Y3diffmin);

	DDX_Text(pDX, IDC_Y4diffmax,Y4diffmax);
	DDX_Text(pDX, IDC_Y4diffmin,Y4diffmin);

	DDX_Text(pDX, IDC_DelayTime,DelayTime);
}
