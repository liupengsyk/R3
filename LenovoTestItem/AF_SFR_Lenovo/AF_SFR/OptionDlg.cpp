...
OptionDlg::OptionDlg(CWnd* pParent, AF_SFR_TestItem* pTestItem)
	...
	, m_bSaveImage(FALSE)
	, m_ROI_Size(0)
	, m_bCheckThrough(FALSE)
	, m_nCnt(0)
	, m_nCodeCount(0)
	, m_sfrOther_Freq(0)
	, m_nPeakCodeDiff(0)
	, m_BPeakCodeDiffEN(FALSE)
	, m_BMacroDiffEn(FALSE)
	, m_nMacroCodeDiff(0)
	, m_BLC(0)
...
void OptionDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_CHKMIDDLE2, m_bCheckThrough);
	DDX_Text(pDX, IDC_SMALL_RANGE2, m_nCnt);
	DDX_Text(pDX, IDC_CODESTEP, m_nCodeCount);
	DDX_Text(pDX, IDC_SFR_TEST_FREQ2, m_sfrOther_Freq);
	DDX_Text(pDX, IDC_PEAKCODEDIFF, m_nPeakCodeDiff);
	DDX_Check(pDX, IDC_CHECK_PEAKCODEDIFFEN, m_BPeakCodeDiffEN);
	DDX_Check(pDX, IDC_CHECK_PEAKCODEDIFFEN2, m_BMacroDiffEn);
	DDX_Text(pDX, IDC_PEAKCODEDIFF2, m_nMacroCodeDiff);
...
BEGIN_MESSAGE_MAP(OptionDlg, CDialog)
	...
	ON_EN_CHANGE(IDC_CODESTEP, &OptionDlg::OnEnChangeCodestep)
END_MESSAGE_MAP()
...
void OptionDlg::OnEnChangeCodestep()
{
