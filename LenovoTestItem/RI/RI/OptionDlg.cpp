...
OptionDlg::OptionDlg(CWnd* pParent, RI_TestItem* pTestItem)
	: CDialog(OptionDlg::IDD, pParent)
{
	m_pTestItem = pTestItem;

	m_RiMinSpec.RI_Min_R = 0.0;
	m_RiMinSpec.RI_Min_Gr = 0.0;
	m_RiMinSpec.RI_Min_Gb = 0.0;
	m_RiMinSpec.RI_Min_B = 0.0;
...
void OptionDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_RI_MIN_R, m_RiMinSpec.RI_Min_R);
	DDX_Text(pDX, IDC_RI_MIN_GR, m_RiMinSpec.RI_Min_Gr);
	DDX_Text(pDX, IDC_RI_MIN_GB, m_RiMinSpec.RI_Min_Gb);
	DDX_Text(pDX, IDC_RI_MIN_B, m_RiMinSpec.RI_Min_B);
