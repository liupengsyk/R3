...
public:
	...
	int  OV08A10_read_i2c(USHORT addr,USHORT &data);
	int OV08A10_readAll(USHORT startAddr,USHORT endAddr,USHORT * out_buf);
	int OV08A10_write_i2c(USHORT addr,USHORT val);
