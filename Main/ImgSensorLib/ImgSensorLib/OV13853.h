...
public:
	...
	int  OV13853_read_i2c(USHORT addr,USHORT &data);
	int OV13853_readAll(USHORT startAddr,USHORT endAddr,USHORT * out_buf);
	int OV13853_write_i2c(USHORT addr,USHORT val);
