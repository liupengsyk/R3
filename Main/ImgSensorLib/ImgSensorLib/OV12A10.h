...
public:
	...
	USHORT  OV12A10_read_i2c(USHORT addr,USHORT &data);
	int OV12A10_readAll(USHORT startAddr,USHORT endAddr,USHORT * out_buf);
	int OV12A10_write_i2c(USHORT addr,USHORT val);
