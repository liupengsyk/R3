...
public:
	...
	virtual int ReadReg(USHORT startAddr, USHORT endAddr, USHORT *buf,USHORT page=1);
	virtual int WriteReg(USHORT startAddr, USHORT endAddr, USHORT *buf, USHORT page=1);
};
