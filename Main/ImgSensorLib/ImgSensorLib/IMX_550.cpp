...
int IMX_550:: ReadReg(USHORT startAddr, USHORT endAddr, USHORT *buf,USHORT page)
{
	return 1;
}
int IMX_550::WriteReg(USHORT startAddr, USHORT endAddr, USHORT *buf,USHORT page)
{
	return 1;
}

BOOL IMX_550::ReadOTPPage(int page, USHORT *ReadData)
{
	
	return 1;

}
int IMX_550::GetTemperature(USHORT &temperature)
{
	return 1;
}
int IMX_550::GetFuseID(CString &FuseID) 
{
	int i = 0;
	int j = 0;
	char section[256] = {0};
	...
	USHORT tempVal[11] = {0};
	if(I2cWrite(0x0A02,0x3F,3) != 1) return 0;
...
int IMX_550::ApplyAWBGain(int rg, int bg, int Typical_rg, int Typical_bg)
{
...
int IMX_550::ApplyLsc(BYTE* raw8,int width,int height,int nLSCTarget,int ob,UCHAR* nLenCReg,int nLenCRegCount,int LSCGroup)
{
	return 1;
}

int IMX_550::spcCal(USHORT *imgBuf,short *pSPC)
{
	return 1;
}

int IMX_550::ApplySpc(short *pSPC)
{
	...
	{                                                                                      
		...
		if(I2cWrite(0x758c+i, pSPC[i+108],3) != 1) return 0;                                 
	}                                                                                      
...
int IMX_550::ReadGain( USHORT &gain)
{
	USHORT GainHigh;
	USHORT GainLow;
...
int IMX_550::WriteGain( USHORT gain)
{
