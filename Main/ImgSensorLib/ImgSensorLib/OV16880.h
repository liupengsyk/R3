...
public:
	...
	int  OV16880_read_i2c(USHORT addr,USHORT &data);
	int OV16880_readAll(USHORT startAddr,USHORT endAddr,USHORT * out_buf);
	int OV16880_write_i2c(USHORT addr,USHORT val);
