...
public:
	...
	int  OV13A40_read_i2c(USHORT addr,USHORT &data);
	int OV13A40_readAll(USHORT startAddr,USHORT endAddr,USHORT * out_buf);
	int OV13A40_write_i2c(USHORT addr,USHORT val);
