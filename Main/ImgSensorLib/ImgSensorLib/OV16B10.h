...
public:
	...
	int  OV16B10_read_i2c(USHORT addr,USHORT &data);
	int OV16B10_readAll(USHORT startAddr,USHORT endAddr,USHORT * out_buf);
	int OV16B10_write_i2c(USHORT addr,USHORT val);
