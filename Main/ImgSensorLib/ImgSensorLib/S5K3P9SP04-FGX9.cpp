...
S5K3P9SP04_FGX9::S5K3P9SP04_FGX9(void)
{
}
...
int S5K3P9SP04_FGX9:: ReadReg(USHORT startAddr, USHORT endAddr, USHORT *buf,USHORT page)
{
	if(NULL == buf) return 0;
	if(I2cRead(startAddr,buf,3) != 1) return 0;
	return 1;
}
int S5K3P9SP04_FGX9::WriteReg(USHORT startAddr, USHORT endAddr, USHORT *buf,USHORT page)
{
	if(NULL == buf) return 0;
	if(I2cWrite(startAddr,*buf,3) != 1) return 0;
	return 1;
}
int S5K3P9SP04_FGX9::GetTemperature(USHORT &temperature)
{
	return 1;
}
int S5K3P9SP04_FGX9::GetFuseID(CString &FuseID) 
{
	FuseID = _T("");
	CString fuseid ;
	char section[512] = {0};
...
int S5K3P9SP04_FGX9::Init()
{
	return 1;
}

int S5K3P9SP04_FGX9::ApplyAWBGain(int rg, int bg, int Typical_rg, int Typical_bg)
{
	...
	if(I2cWrite( 0x6028, 0x4000,  4) != 1) return 0;	                
	if(I2cWrite( 0x602a, 0x020D,  4) != 1) return 0;                  
...
int S5K3P9SP04_FGX9::ApplyLsc(BYTE* raw8,int width,int height,int nLSCTarget,int ob,UCHAR* nLenCReg,int nLenCRegCount,int LSCGroup)
{
	return 1;
}

int S5K3P9SP04_FGX9::spcCal(USHORT *imgBuf,short *pSPC)
{
	return 1;
}
int S5K3P9SP04_FGX9::ApplySpc(short *pSPC)
{
	return 1;
}

int S5K3P9SP04_FGX9::ReadExp( int &exp)
{
	USHORT ExpHigh;
	USHORT ExpLow;
...
int S5K3P9SP04_FGX9::WriteExp( int exp)
{
...
int S5K3P9SP04_FGX9::ReadGain( USHORT &gain)
{
	USHORT GainHigh;
	USHORT GainLow;
...
int S5K3P9SP04_FGX9::WriteGain( USHORT gain)
{
