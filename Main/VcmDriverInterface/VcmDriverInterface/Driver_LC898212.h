...
//signed short	Hall_Max = 0x6f2b;//0x6900; // Please read INF position from EEPROM or OTP
//signed short  	Hall_Min = 0x9125;//0x9300; // Please read MACRO position from EEPROM or OTP
...
class Driver_LC898212 :
	public CVcmDriverInterface
{
public:
	Driver_LC898212(void);
	~Driver_LC898212(void);
...
public:
	...
	void RegWriteA(unsigned short addr, unsigned short data);
