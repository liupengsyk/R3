...
WINAPI
GetIpAddrTable(
    __out_bcount_opt(*pdwSize) OUT    PMIB_IPADDRTABLE pIpAddrTable,
    IN OUT PULONG           pdwSize,
    IN     BOOL             bOrder
    );
...
WINAPI
GetAdaptersInfo(
    __out_bcount_opt(*pOutBufLen) PIP_ADAPTER_INFO pAdapterInfo, PULONG pOutBufLen
    );
...
GetAdaptersAddresses(
    ...
    IN     DWORD                 Flags,
    IN     PVOID                 Reserved,
    __out_bcount_opt(*pOutBufLen) OUT    PIP_ADAPTER_ADDRESSES pAdapterAddresses, 
...
WINAPI
GetPerAdapterInfo(
    ULONG IfIndex, __out_bcount_opt(*pOutBufLen) PIP_PER_ADAPTER_INFO pPerAdapterInfo, PULONG pOutBufLen
    );
