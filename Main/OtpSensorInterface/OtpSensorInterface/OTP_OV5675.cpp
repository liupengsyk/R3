...
int OTP_OV5675::OtpInit()
{	
	return 0;
}
int OTP_OV5675::OtpRead(USHORT startAddr, USHORT endAddr, USHORT *buf,USHORT page)
{ 
...
int OTP_OV5675::OtpWrite(USHORT startAddr, USHORT endAddr, USHORT *buf,USHORT page)
{	 
	if (NULL == buf || endAddr < startAddr)	return 0;
