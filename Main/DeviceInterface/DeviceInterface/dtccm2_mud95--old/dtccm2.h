...
/// @retval DT_ERROR_FAILED：获取设备的硬件信息失败
/// @retval DT_ERROR_COMM_ERROR：通讯错误 
DTCCM_API int _DTCALL_ ReadUserDefinedName(char *pName, int iBufferSize,int iDevID=DEFAULT_DEV_ID);
...
/// @brief 设置I2C的字节间隔(暂只支持HS系列),PE950支持
///
/// @brief uInterval：字节间隔设置
