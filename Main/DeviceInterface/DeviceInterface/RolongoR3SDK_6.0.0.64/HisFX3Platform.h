...
public:
	...
	*/
	int HisFX3OpenDevice(unsigned short usPID=0, unsigned short usVID=0, char* pstrFriendlyName=NULL, unsigned char ucDeviceIndex=0xFF, unsigned int* puiKey = NULL);
...
*/
	...
	//! 设置USB传输速率
	/*!
	\param[in] uiSpeed   范围：190~335 MB/s
	\return 0:成功  非0:失败 请参考_HisFX3Platform_ErrorCode
	\sa  _HisFX3Platform_ErrorCode
	*/
