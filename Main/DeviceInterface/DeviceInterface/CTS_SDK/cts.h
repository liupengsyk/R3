...
//CTS_API int Cam_PreviewVideoPlay(DWORD devInst, HWND hwnd, int width, int height, unsigned char nDataFormat, unsigned char nDisplayFormat, unsigned char nBayerOrder);
//CTS_API void Cam_PreviewVideoStop(DWORD devInst);
...
CTS_API unsigned char Cam_IsCCMLost(DWORD devInst, bool bVideoInitRunning);
