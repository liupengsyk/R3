...
/// @param pValue：向EEPROM写到字
///
/// @retval DT_ERROR_OK：写EEPROM成功
/// @retval DT_ERROR_FAILD：写EEPROM失败
/// @retval DT_ERROR_INTERNAL_ERROR：内部错误
/// @retval DT_ERROR_COMM_ERROR：通讯错误
...
///
/// @param  bRapid=1表示，输出高电平时，由单片机GPIO输出灌电流，=0，表示高电平时，I2C管脚为输入状态，借助外部上拉变成高电平
///							 
/// @retval DT_ERROR_OK：设置总线速率操作成功
...
DTCCM_API int _DTCALL_ SensorSpiInit(BOOL bEnable, int iRate=FALSE, BOOL bType=FALSE, int iDevID=DEFAULT_DEV_ID);
...
/// @see CURRENT_RANGE
///
/// @note 该函数仅PE910/PE910D/HV910/HV910D支持。
...
/// @brief 设置电压上升沿，设定值(Rise)单位:mV/S。
///
/// @param Power：电源类型，参见枚举类型“SENSOR_POWER”
/// @param Rise：电压上升沿值，单位:mV/S
/// @param iCount：电源路数
///
...
/// @retval DT_ERROR_FAILD：OS开关状态值读取失败
/// @retval DT_ERROR_COMM_ERROR：通讯错误
