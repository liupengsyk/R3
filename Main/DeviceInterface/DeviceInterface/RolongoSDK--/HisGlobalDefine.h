...
enum _HisFX3_Platform_Type
{
	...
	_HisFX3_Platform_Type_RTSP			=	0x7
};
...
struct _HisFX3_PreviewStruct{
	...
	unsigned char ucDVP_LineFormat; /*!< DVP数据线设置  0：采9:2   1: 采7:0   2：采15:0 */
	...
	*/
	...
	unsigned char ucVolt_DOVDD; /*!< 设置DOVDD电压，0.0~3.5范围可调, eg.2.8V, 应设28 */
	unsigned char ucVolt_DVDD; /*!< 设置DVDD电压，0.0~3.5范围可调, eg.2.8V, 应设28  */
	unsigned char ucVolt_AVDD; /*!< 设置AVDD电压，0.0~3.5范围可调, eg.2.8V, 应设28  */
	unsigned char ucVolt_AF; /*!< 设置AF电压，0.0~3.5范围可调, eg.2.8V, 应设28  */
	unsigned char ucVolt_VFuse; /*!< 设置DOVDD电压，0.0~10.0范围可调, eg.2.8V, 应设28  */
	unsigned char ucVolt_POW; /*!< 设置POW电压，0.0~3.5范围可调, eg.2.8V, 应设28  */
	unsigned char ucVolt_IODD; /*!< 设置IODD电压【板卡内部IO电平】【R5】，0.0~3.5范围可调, eg.2.8V, 应设28  */
	...
	float flMCLK; /*!< 设置MCLK。 0~136MHz范围可调*/
	/*! 设置板卡上传的数据格式
	...
	*/
	...
	_HisFX3_PreviewStruct(void)
	{
		...
		ucVolt_DOVDD	=	ucVolt_DVDD = ucVolt_AVDD =ucVolt_AF =ucVolt_VFuse =ucVolt_POW = ucVolt_IODD =0;
...
struct _HisFX3_Current_Calibration{
	...
	float flWorkOTP[_HisFX3V2_CURRENTCAL_COUNT];
	...
	_HisFX3_Current_Calibration()
	{
		...
		memset(flWorkOTP, 0, sizeof(float) *_HisFX3V2_CURRENTCAL_COUNT);
...
struct _HisFX3OS_Positive_Item{
	...
	*/
	...
	bool bAGND; /*!< true：对AGND做开路测试		false：对DGND做开路测试 */
...
enum _HisFX3Platform_ErrorCode{
	...
	HisTcpIpError_dualcameracoaxialitytest	=	0x40801
}; 
...
//	_FrameType_YUV422_U8				=	0x08, //YUV422_U8
...
enum _HISLOG_CLASSIFY{
	...
	_HISLOG_CLASSIFY_OHMTEST						=	2900,
	_HISLOG_CLASSIFY_MICTEST						=	3000,
	_HISLOG_CLASSIFY_LEDTEST						=	3100,
	_HISLOG_CLASSIFY_FWBURN						=	3200
};
...
struct _HisCCMAlg_AFC_Tactics_Basic{
	...
	{
		bTestStartMotor = bLinearBack	=	false;
		bDataBase		=	true;
		usMaxSteps	=	1;
		usStepDelay	=	500;
...
typedef int (__stdcall *hardwaresetvolt)(unsigned char, unsigned char, unsigned char, unsigned char,unsigned char, unsigned char, unsigned char, unsigned char);
typedef int (__stdcall *hardwaregetvolt)(unsigned char*, unsigned char*, unsigned char*, unsigned char*, unsigned char*, unsigned char*, unsigned char*);

typedef int (__stdcall *hardwaresetvfuse)(unsigned char);
typedef int (__stdcall *hardwaregetvfuse)(unsigned char*);
